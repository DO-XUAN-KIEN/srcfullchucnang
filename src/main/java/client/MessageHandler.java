...
//                        }
    ...
    public static void dataloginmap(Session conn) throws IOException {
        ...
        Service.send_notice_nobox_yellow(conn, ("Chào Mừng Bạn Đến Với Kỷ nguyên hso !! ")); //Số người online : " + (Session.client_entrys.size() + 30)));
        send_notice_nobox_white(conn, ("Đổi Coin Sang Vàng Ngọc Tại Npc Zuru - Nạp Coin Tại Kỷ nguyên hso  "));
